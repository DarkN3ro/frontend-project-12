    ...
    <div className="container h-100 my-4 overflow-hidden rounded shadow">
      <div className="row h-100 bg-white flex-md-row">
        <div className="col-4 col-md-2 border-end px-0 bg-light flex-column h-100 d-flex">
          <div className="d-flex mt-1 justify-content-between mb-2 ps-4 pe-2 p4">
            <b>Channels</b>
          ...
          <ul id="channels-box" className="nav flex-column nav-pillis nav-fill px-2 mb-3 overflow-auto h-100 d-block">
            <li>
            ...
            <div className="mt-auto px-5 py-3">
              <form novalidate className="py-1 border rounded-2">
                <div className="input-group has-validation">
                  <input name="body" aria-label="New message" placeholder="Entry messages..." className="border-0 p-0 ps-2 form-control" value />
                  <button type="submit" disabled className="btn btn-group-vertical">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="20" height="20" fill="currentColor" class="bi bi-arrow-right-square">
